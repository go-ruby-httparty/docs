...
The public API lives at the module root (`github.com/go-ruby-httparty/httparty`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `httparty`, while the surface follows
...
```go
import "github.com/go-ruby-httparty/httparty"
```
...
- **[pkg.go.dev/github.com/go-ruby-httparty/httparty](https://pkg.go.dev/github.com/go-ruby-httparty/httparty)**

The module's [README](https://github.com/go-ruby-httparty/httparty#readme) carries worked
